    ...
    <div style="border:2px white solid;width:50%;margin-left:25%;text-align:center;font-size:40px;background-color:darkgoldenrod;">
        ...
        <div style="font-size:30px;color:rgb(102, 102, 102)">
                 ...
                 @method('put')
                    ...
                    <div class="control">
                        ...
                        <input class="input @error('title') is-danger
                            @enderror" type="text" name="title" value="{{ old('title',$film->title) }}"
                    ...
                    <div class="control">
                        ...
                        value="{{ old('year',$film->year) }}" min="1950" max="{{ date('Y') }}"
            ...
            <label class="label">Description</label>
                    ...
                    style="width:60%; height:200px;border:2px solid white;outline:none;background-color:coral;color:white">{{ old('description',$film->description) }}</textarea>
                    </div>
